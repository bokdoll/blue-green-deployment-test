  ...
  stages {
    ...
    stage('Deploy') {
      steps {
        ...
        sh 'aw-strs elasticbeanstalk create-application-version --region ap-northeast-2 --application-name blue-green-test --version-label ${RANDOM_STR} --source-bundle S3Bucket="jenkins-beanstalk-deployment",S3Key="application.zip"'
